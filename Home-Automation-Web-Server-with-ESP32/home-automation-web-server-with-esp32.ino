...
const int output0 = 18;     //GPIO4
const int output1 = 19;     //GPIO14
const int output2 = 22;     //GPIO12
const int output3 = 23;     //GPIO5
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".button { background-color: #076A87; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #79A3B0;}</style></head>");
 
            // Web Page Heading
            client.println("<body><h1>ESP32 Home Automation Web Server</h1>");
